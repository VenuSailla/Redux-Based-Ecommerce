          ...
          <form class='me-5'>
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <Link class="nav-link active text-dark font" aria-current="page" to="/CartIcon"><h5><i class="bi bi-cart-fill "></i> <sup className='bg-danger p-1 rounded-circle'>{cartIcon.length}</sup></h5></Link>
                </li>
              </ul>
            </div>
          </form>
